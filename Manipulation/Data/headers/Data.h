...
__menu change_data1[4];                     // Меню изменения данных пользователя
__menu change_data1_1[2];                   // Меню изменения финансового состояния пользователя
__menu change_data1_2[8];                   // Меню изменения навыков пользователя
__menu change_data1_3[7];                   // Меню изменения целей пользователя
__menu change_data1_4[7];                   // Меню изменения задач пользователя
